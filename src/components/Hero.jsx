...
const Hero = () => {
  const heroContent = [
    {
      title: "Edulga makes learning adaptive, personalized, and truly impactful for the digital age.",
      subtitle: "Hyper-Personalized Learning: AI-driven, real-time learning paths tailored to individual goals, skills, and the latest job market trends..",
